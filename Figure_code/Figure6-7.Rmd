...
p1 <- Stacked_VlnPlot(all.merge, features = c ('vcp','clic4','tmod1','hspb1','ldha','slmapa','cdh13','sdha','sgcd'),idents = c("zebrafish_uninjured","medaka_3dpi","medaka_uninjured","zebrafish_3dpi"), colors_use = vln_3dpi,  x_lab_rotate = TRUE)

p2 <- Stacked_VlnPlot(all.merge, features = c('Vcp',"Clic4","Tmod1","Hspb1","Ldha","Slmap","Cdh13","Sdha","Sgcd"), pt.size = 0, idents = c("p4.sham","p4.3dpi","p11.sham","p11.3dpi"), colors_use = ms_color, x_lab_rotate = TRUE)
