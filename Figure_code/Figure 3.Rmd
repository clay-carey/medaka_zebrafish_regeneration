...
ZFcondition <- c("Uninjured","Uninjured","Uninjured","Uninjured","3 d.p.i","3 d.p.i","3 d.p.i","3 d.p.i ","3 d.p.i ","3 d.p.i ","14 d.p.i","14 d.p.i","14 d.p.i","14 d.p.i ","14 d.p.i ","14 d.p.i ")
ZFtotalmpeg <- data.frame(ZFmpegpos,ZFcondition)
ZFtotalmpeg$ZFcondition <- factor(ZFtotalmpeg$ZFcondition , levels=c("Uninjured", "3 d.p.i","14 d.p.i","3 d.p.i ","14 d.p.i "))

boxplot(ZFtotalmpeg$ZFmpegpos~ZFtotalmpeg$ZFcondition, data=ZFtotalmpeg, main = "Zebrafish",xlab="Condition",ylab="Number mpeg+cells/mm", col=zf_macro_cols,ylim = c(0,3000))

MDmpegpos <- c(1186,783,1159,227,340,150,751,1502,981,314,467,190,2159,1426,786)
MDcondition <- c("Uninjured","Uninjured","Uninjured","3 d.p.i","3 d.p.i","3 d.p.i","3 d.p.i ","3 d.p.i ","3 d.p.i ","14 d.p.i","14 d.p.i","14 d.p.i","14 d.p.i ","14 d.p.i ","14 d.p.i ")
MDtotalmpeg <- data.frame(MDmpegpos,MDcondition)
MDtotalmpeg$MDcondition <- factor(MDtotalmpeg$MDcondition,levels = c("Uninjured", "3 d.p.i","14 d.p.i","3 d.p.i ","14 d.p.i "))

boxplot(MDtotalmpeg$MDmpegpos~MDtotalmpeg$MDcondition, data=MDtotalmpeg, main = "Medaka",xlab="Condition",ylab="Number mpeg+cells/mm", col=md_macro_cols,ylim = c(0,3000)) 
