...
```{r}
heart_integrated <- readRDS(file = '/Users/claytoncarey/Documents/Seurat/medaka_zebrafish_regeneration/heart_integrated.rds')
heart_integrated
```
...
FeaturePlot(heart_integrated, features = 'hbaa1', pt.size = 0.01)
...
```{r}
FeaturePlot(heart_filtered, features = 'percent.mt')
```
...
FeaturePlot_scCustom(heart_filtered, features = c('fli1a','kdrl','tcf21','hbba1'))
```
...
```{r}
heart_filtered@meta.data <- mutate(heart_filtered@meta.data, cell_class_species = case_when(
  cell_class == "Endothelium" & species == 'zebrafish' ~ "Endothelium (Zebrafish)",
  cell_class == "Endothelium" & species == 'medaka' ~ "Endothelium (Medaka)",
  cell_class == "Epicardium" & species == 'zebrafish' ~ "Epicardium (Zebrafish)",
  cell_class == "Epicardium" & species == 'medaka' ~ "Epicardium (Medaka)",
  cell_class == "Cardiomyocyte" & species == 'zebrafish' ~ "Cardiomyocyte (Zebrafish)",
  cell_class == "Cardiomyocyte" & species == 'medaka' ~ "Cardiomyocyte (Medaka)",
  cell_class == "Leukocyte" & species == 'zebrafish' ~ "Leukocyte (Zebrafish)",
  cell_class == "Leukocyte" & species == 'medaka' ~ "Leukocyte (Medaka)",
  cell_class == "Mural" & species == 'zebrafish' ~ "Mural (Zebrafish)",
  cell_class == "Mural" & species == 'medaka' ~ "Mural (Medaka)"
))
```
